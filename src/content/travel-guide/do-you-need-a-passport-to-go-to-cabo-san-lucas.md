...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do you need a passport to go to Cabo San Lucas in 2026?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. If you are a foreign traveler going to Cabo San Lucas, you need a valid, unexpired passport. Mexico requires foreign nationals entering by air, land, or sea to present a valid passport, and it must remain valid for the duration of your trip."
      }
    },
    {
      "@type": "Question",
      "name": "Do US citizens need a visa for Cabo San Lucas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. U.S. citizens do not need a visa to visit Cabo San Lucas for tourism stays of up to 180 days. You only need a valid U.S. passport. Entry is subject to review by Mexican immigration authorities at the port of entry."
      }
    },
    {
      "@type": "Question",
      "name": "Can I go to Cabo San Lucas on a cruise without a passport?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Mexican consular guidance states that cruise passengers visiting Mexican ports generally do not need a visa, but they should still carry a valid, unexpired passport or travel document. Check your cruise line's specific requirements as well."
      }
    },
    {
      "@type": "Question",
      "name": "How long does my passport need to be valid to enter Mexico?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Mexico only requires that your passport be valid for the duration of your stay — there is no six-month rule. However, some airlines may apply additional passport-validity rules, so confirm directly with your carrier before your flight."
      }
    },
    {
      "@type": "Question",
      "name": "Do children need a passport to travel to Cabo San Lucas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, minors should travel with their own valid passport. For short tourist stays, children generally do not need a parental authorization letter to enter Mexico, though some airlines may require additional forms for unaccompanied minors."
      }
    }
  ]
}
